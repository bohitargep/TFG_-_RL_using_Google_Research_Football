...
def plotAll(scenario: str, algorithm: str, politic: str, sample_rate: int):
    global n
    n += 1
    plt.figure(n)
    ...
    plt.suptitle("Precisión a lo largo del entrenamiento")
    plt.title("{} - {} - {}"
    ...
    plt.axis([0, (x_length+1)*sample_rate, 0, 1])

    plt.savefig('Graphs/plotAll {} {} {}.pdf'
                    .format(scenario[12:], algorithm, politic))


def plotLimAverage(scenario: str, algorithm: str, politic: str, sample_rate: int):
    global n
    n += 1
    plt.figure(n)
    ...
    plt.suptitle("Precisión mínima, máxima y media a lo largo del entrenamiento")
    plt.title("{} - {} - {}"
                .format(scenario[12:], algorithm, politic),
                y=1.01,
                fontsize=10)
    ...
    plt.plot(eps, min, color='tab:red')
    plt.plot(eps, max, color='tab:green')
    plt.fill_between(eps, min, max, facecolor='tab:blue', alpha=0.15)
    plt.plot(eps, average, color='tab:blue')

    plt.savefig('Graphs/plotMinMaxAvg {} {} {}.pdf'
                    .format(scenario[12:], algorithm, politic))
